  ...
  const handleUpdatePassword = async () => {
    if (window.ethereum && id && newPassword) {
      try {
        ...
        const contract = new ethers.Contract(contractAddress, contractABI, signer);
        //const encryptedHash = ethers.utils.sha256(ethers.utils.toUtf8Bytes(newPassword)); // Example encryption, replace with actual
        const encryptedHash = "test123pretendthisisencrypted";
