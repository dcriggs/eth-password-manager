 ...
 */
const deployShareablePasswordManager: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
  ...
  */
  ...
  await deploy("ShareablePasswordManager", {
    from: deployer,
...
// e.g. yarn deploy --tags ShareablePasswordManager
deployShareablePasswordManager.tags = ["ShareablePasswordManager"];
